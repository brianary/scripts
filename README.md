...
[![Pester tests coverage](https://img.shields.io/badge/Pester_coverage-2406_%E2%80%B1-red)](https://github.com/brianary/scripts/tree/main/test)
...
- :new: **[Get-NuGetConfigs.ps1](Get-NuGetConfigs.ps1)**: Returns the available NuGet configuration files, in order of preference.
...
- :new: **[Backup-Workstation.ps1](Backup-Workstation.ps1)**: Adds various configuration files and exported settings to a ZIP file.
...
- :up: **[Copy-Html.ps1](Copy-Html.ps1)**: Copies objects as an HTML table.
...
- :new: **[Restore-Workstation.ps1](Restore-Workstation.ps1)**: Restores various configuration files and exported settings from a ZIP file.
