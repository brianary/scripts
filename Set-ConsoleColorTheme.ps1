...
switch($ThemeName)
{
    ...
    SolarizedDark {Set-ConsoleColors.ps1 -BG 0x002B36 -FG 0x93A1A1 -EFG 0xDC322F -EBG 0x073642 -WFG 0xB58900 -STR 0x859900 -VAR 0x6C71C4 -OP 0x2AA198}
    SolarizedLight {Set-ConsoleColors.ps1 -BG 0xFDF6E3 -FG 0x93A1A1 -EFG 0xDC322F -EBG 0xEEE8D5 -WFG 0xB58900 -STR 0x859900 -VAR 0x6C71C4 -OP 0x2AA198}
